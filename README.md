...
- Add small blind and big blind logic
- Add all-in and side-pot handling
- Improve minimum raise rules
- Add persistent game sessions with a database
- Add multiple bots through the API
- Improve bot strategy with position, betting history, and opponent modeling
- Add a polished web UI with a poker table layout
- Add unit tests for hand evaluation and API behavior

## Notes

This project is intended as a learning/demo project for poker logic, backend APIs, and basic game AI. It is not designed for gambling or real-money play.
